...
<head>
  ...
  <!-- Basic Page Needs
  ================================================== -->
  <title>Fédération Malagasy du Basket-Ball</title>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="description" content="{{ $parameters->description }}">
  <meta name="author" content="oktobone Technology">
  <meta name="keywords" content="{{ $parameters->tags }}">
  ...
  <div class="site-wrapper clearfix">
    ...
    <div class="header-mobile clearfix" id="header-mobile">
      <div class="header-mobile__logo">
        <a href="index.html"><img src="{{asset('assets/images/'.$logo)}}" srcset="{{asset('assets/images/'.$logo)}} 2x" alt="FMBB" class="header-mobile__logo-img"></a>
      </div>
