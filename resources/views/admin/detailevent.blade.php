                                ...
                                <div class="userWidget-1">
                                    @foreach($event as $ev)
                                        <div class="avatar bg-{{ $color[rand('0','5')] }}">
                                            <img src="{{link_img('images/'.$ev->urlogoevent)}}" alt="avatar">
                                                    ...
                                                    <table class="table table-hover table-vcenter">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                	<div class="media-object center"> <img src="{{link_img('images/'.$result[$a][$b]->LOGOURL)}}" alt="" class="img-rounded img-sm"> </div>
                                                                </td>
