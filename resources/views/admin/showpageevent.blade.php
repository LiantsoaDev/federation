...
<style>
  .modal-header, h4, .close {
      background-image: url("{{link_img('images/coupe-president.jpg')}}");
                                                ...
                                                <div id="demo-lft-tab-1" class="tab-pane fade active in">
                                                    ...
                                                    <table class="table table-hover table-vcenter">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="hidden-xs">
                                                                    <div class="media-object center"> <img src="{{link_img('images/'.$chmps->urlogoevent)}}" alt="" class="img-rounded img-sm"> </div>
                                                                </td>
                                                ...
                                                <div id="demo-lft-tab-3" class="tab-pane fade">
                                                    ...
                                                    <table class="table table-hover table-vcenter">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="hidden-xs">
                                                                    <div class="media-object center"> <img src="{{link_img('images/'.$league->urlogoevent)}}" alt="" class="img-rounded img-sm"> </div>
                                                                </td>
