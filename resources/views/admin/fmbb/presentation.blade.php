...
<section id="page-content">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Formulaire de présentation de la fmbb</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                ...
                                data-upload-template-id="template-upload-1" data-download-template-id="template-download-1" onsubmit="return postTextarea()">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-textarea-input">Titre de la présentation</label>
                                            <div class="col-md-9">
                                                <textarea id="demo-textarea-input" rows="2" class="form-control" name="titre" placeholder="le Titre ici..." required="required">{{$datas->titre}}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <!--Summernote-->
                                        <!--===================================================-->
                                        <textarea class="form-control" rows="15" cols="10" name="presentation">{{ $datas->presentation }}</textarea>
                                        <!--===================================================-->
                                        <!-- End Summernote -->
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <p>Un tag (ou étiquette, marqueur, libellé) est un mot-clé (signifiant) ou terme associé ou assigné à de l'information (par exemple une image, un article, ou un clip vidéo), qui décrit une caractéristique de l'objet et permet un regroupement facile des informations contenant les mêmes mots-clés.</p><br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="jquery-tagIt-inverse" class="inverse" name="tags" value="{{$datas->tags}}">
                                                </div>
                                            </div>
                                    </div>
                                </div>
 ...
 <script>
    var postTextarea = function() {
        var content = $('textarea[name="presentation"]').html($('#demo-summernote').code());
    }
</script>
