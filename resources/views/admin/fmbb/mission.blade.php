...
<section id="page-content">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Missions et Attributions de la fmbb</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    <form method="post" action="{{ route('admin.fmbb.add-mission') }}" class="panel-body form-horizontal" enctype="multipart/form-data"
                                data-upload-template-id="template-upload-1" data-download-template-id="template-download-1" onsubmit="return postTextarea()">
                                		{{ csrf_field() }}
                                        <!--Textarea-->
                                        <input type="hidden" name="id" value="{{ (empty($datas->id)) ? null : $datas->id }}"/>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-textarea-input">Titre du Paragraphe (Missions et attributions )</label>
                                            <div class="col-md-9">
                                                <input class="form-control" name="title" placeholder="le Titre ici..." value="{{ (empty($datas->titre))? null : $datas->titre }}" required="required">
                                            </div>
                                        </div>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <!--Summernote-->
                                        <!--===================================================-->
                                        <textarea class="form-control" rows="15" cols="10" name="content">{!! (empty($datas->contenu)? null : $datas->contenu) !!}</textarea>
                                        <!--===================================================-->
                                        <!-- End Summernote -->
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <p>Un tag (ou étiquette, marqueur, libellé) est un mot-clé (signifiant) ou terme associé ou assigné à de l'information (par exemple une image, un article, ou un clip vidéo), qui décrit une caractéristique de l'objet et permet un regroupement facile des informations contenant les mêmes mots-clés.</p><br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="jquery-tagIt-inverse" class="inverse" name="tags" value="{{ ( empty($datas->tags) ) ? null : $datas->tags}}">
                                                </div>
                                            </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <!--===================================================-->
                                        <input id="input-b3" name="files" type="file" class="file" data-show-upload="false" data-show-caption="true" data-msg-placeholder="Select {files} for upload...">
                                        <!--===================================================-->
 ...
 <script>
    var postTextarea = function() {
        var content = $('textarea[name="content"]').html($('#demo-summernote').code());
    }
</script>
