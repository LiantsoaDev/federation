         ...
         <div class="panel" id="txtHint">
             ...
             <div class="panel-body">  
                    <div class="row">
                            <div class="col-xs-5">
                                            <div class="col-xs-6">
                                                <div class="media-object center"> <img src="{{link_img('images/'.$info->teamA->LOGOURL)}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                             <div class="col-xs-6">
                                      ...
                                      <div class="col-xs-5">
                                             ...
                                             <div class="col-xs-6">
                                                <div class="media-object pull-right"> <img src="{{link_img('images/'.$info->teamB->LOGOURL)}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                      </div>
					</div>
         ...
         <div class="panel">
             ...
             <div class="panel-body">
                    <div class="row">
                            <div class="col-xs-5">
                                            <div class="col-xs-6">
                                                <div class="media-object center"> <img src="{{link_img('images/'.$quart->teamA->LOGOURL)}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                             <div class="col-xs-6">
                                      ...
                                      <div class="col-xs-5">
                                             ...
                                             <div class="col-xs-6">
                                                <div class="media-object pull-right"> <img src="{{link_img('images/'.$quart->teamB->LOGOURL)}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                      </div>
          </div>
         ...
         <div class="panel">
             ...
             <div class="panel-body">
                    <div class="row">
                            <div class="col-xs-5">
                                            <div class="col-xs-6">
                                                <div class="media-object center"> <img src="{{link_img('$demi->teamA->LOGOURL')}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                             <div class="col-xs-6">
                                      ...
                                      <div class="col-xs-5">
                                             ...
                                             <div class="col-xs-6">
                                                <div class="media-object pull-right"> <img src="{{link_img('images/'.$demi->teamB->LOGOURL)}}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                      </div>
          </div>
         ...
         <div class="panel">
             ...
             <div class="panel-body">
                    <div class="row">
                            <div class="col-xs-5">
                                            <div class="col-xs-6">
                                                <div class="media-object center"> <img src="{{link_img('images/'.$final->teamA->LOGOURL)}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                             <div class="col-xs-6">
                                      ...
                                      <div class="col-xs-5">
                                             ...
                                             <div class="col-xs-6">
                                                <div class="media-object pull-right"> <img src="{{link_img('images/'.$final->teamB->LOGOURL)}}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                      </div>
          </div>
