                     ...
                     <div class="col-lg-4 col-sm-6 col-md-6 col-xs-12">
                                <div class="userWidget-1">
                                    <div class="avatar bg-dark">
                                        <img src="{{ link_img('images/'.$result->equipe1->LOGOURL) }}" alt="avatar">
                            ...
                            <div class="col-lg-4 col-sm-6 col-md-6 col-xs-12">
                                <div class="userWidget-1">
                                    <div class="avatar bg-dark">
                                        <img src="{{link_img('images/'.$result->equipe2->LOGOURL)}}" alt="avatar">
            ...
            <div class="col-xs-8">
                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                       <div class="col-xs-5">
                                            <div class="col-xs-6">
                                                <div class="media-object center"> <img src="{{ link_img('images/'.$bcl->equipe1->logo) }}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                             <div class="col-xs-6">
                                      ...
                                      <div class="col-xs-5">
                                             ...
                                             <div class="col-xs-6">
                                                <div class="media-object pull-right"> <img src="{{ link_img('images/'.$bcl->equipe2->logo) }}" width="80px" height="80px" alt="" class="img-circle"> </div>
                                            </div>
                                      </div>
                                    </div><!-- end panel-body-->
                                </div>
