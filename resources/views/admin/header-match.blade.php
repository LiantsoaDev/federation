...
<head>
        ...
        <title> Back-Office | Fédération Malagasy du BasketBall</title>
                        ...
                        <ul class="nav navbar-top-links pull-right">
                            ...
                            <li id="dropdown-user" class="dropdown">
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                    <span class="pull-right"> <img class="img-circle img-user media-object" src="{{link_img('assets/images/logo-fmbb.png')}}" alt="Profile Picture"> </span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right with-arrow">
                                    ...
                                    <ul class="head-list">
                                        ...
                                        <li>
                                            <a id="btnLogout" href="{{ route('logout') }}"
            ...
            <div class="boxed">
                ...
                <section id="content-container">
                    <header class="pageheader hidden-xs">
                        <h3><i class="fa fa-home"></i> fédération Malagasy du Basket-Ball </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">Chemin repertoire:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
